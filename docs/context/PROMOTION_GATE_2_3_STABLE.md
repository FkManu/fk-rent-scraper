# PROMOTION_GATE_2_3_STABLE.md

## Scopo
Definire quando una patch nata in `2.3_stable` puo essere promossa verso la linea shipping derivata da `2.2 stable`.
...
Una patch di `2.3_stable` puo essere candidata alla promozione solo se:
...
## Nota pratica
La `2.3_stable` non nasce per riversare patch subito.
